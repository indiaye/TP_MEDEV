...
public class Joueur {
    ...
    /**
     * Méthode sans argument dans la classe Joueur qui retourne le nombre de
     * gares possédées par le joueur
     *
     ...
     * @throws NoMoreMoney exception quand le joueur n'a pas assez d'argent pour
     * payer
     */
